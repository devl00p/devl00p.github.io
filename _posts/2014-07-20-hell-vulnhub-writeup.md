...
It looks like the program is opening some port :  
...
When we give a name long enough the program segfaults (this verb should be added to the dictionary). No core file is generated.  
