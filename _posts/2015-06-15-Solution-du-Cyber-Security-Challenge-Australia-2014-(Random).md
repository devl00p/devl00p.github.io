...
![Ouverture en mode raw](/assets/img/cysca/gimp_raw_open.png)

Comme les entêtes sont inconnus on doit spécifier nous même la longueur et largeur de l'image :  

![Premiere ouverture](/assets/img/cysca/gimp_alpha_rvb.png)

Par tâtonnements on trouve des paramètres valides :  

![Recherche des bons paramètres](/assets/img/cysca/gimp_ecb_size.png)

Et après quelques retouches artistiques :  

![Après quelques retouches](/assets/img/cysca/gimp_final.png)
...
![Code QR extrait de la photo](/assets/img/cysca/wounded_qr_code.jpg)
...
![QR clean](/assets/img/cysca/qr.png)
...
![QR code V3](/assets/img/cysca/pattern_big.png)
...
![Code QR en partie corrigé](/assets/img/cysca/qr_fixed.png)
