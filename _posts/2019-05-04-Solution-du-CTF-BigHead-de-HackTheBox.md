...
![BigHead mailer form](/assets/img/htb/bighead_mailer.png)
...
Ce dépôt a eu 4 commits dont deux concernent un fichier `BHWS_Backup.zip`.  
...
![BigHead CTF CreateThread](/assets/img/htb/bighead_create_thread.png)
...
![BigHead CTF handler function init](/assets/img/htb/bighead_handler_init.png)

Le buffer de 524 est utilisé pour stocker les données reçues par *recv()* qui tente justement de lire 524 octets.  

![BigHead CTF handler recv](/assets/img/htb/bighead_handler_recv.png)
...
![BigHead CTF request length check](/assets/img/htb/bighead_recv_length_check.png)
...
![CTF BigHead strtoul loop init](/assets/img/htb/bighead_strtoul_loop_init.png)
...
![CTF BigHead strtoul loop](/assets/img/htb/bighead_strtoul_loop.png)
...
![BigHead strcpy vulnerability CTF](/assets/img/htb/bighead_strcpy.png)
...
![BigHead crash in ImmunityDebugger](/assets/img/htb/bighead_crash.png)
...
![BigHead CTF jmp eax to int 3](/assets/img/htb/bighead_jmp_eax_cc.png)
...
![BigHead CTF Nginx Keep-Alive Wireshark capture](/assets/img/htb/bighead_keep_alive.png)
...
![BigHead CTF Nginx proxy_pass Connection: Close Wireshark capture](/assets/img/htb/bighead_cnx_close.png)
...
![BigHead CTF root flag KeePass](/assets/img/htb/bighead_root_flag.png)
