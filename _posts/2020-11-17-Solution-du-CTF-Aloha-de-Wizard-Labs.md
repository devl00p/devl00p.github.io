...
![Wizard Labs CTF Aloha wordpress blog](/assets/img/wizard-labs/aloha_blog.png)

On garde en tête le possible nom d'utilisateur *alex* et on se rend sur l'URL mentionnée :  

![Wizard Labs CTF Aloha php scraper vulnerable script](/assets/img/wizard-labs/aloha_scaper.png)
...
![Wizard Labs CTF Aloha webshell ](/assets/img/wizard-labs/aloha_rce.png)
