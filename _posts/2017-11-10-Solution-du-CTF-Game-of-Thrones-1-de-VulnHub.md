...
![Map to Westeros](/assets/img/GoT/map_to_westeros.jpg)
...
![stark_shield.jpg](/assets/img/GoT/stark_shield.jpg)
...
![Metasploit Webmin options exploit](/assets/img/GoT/webmin_msf_options.png)

![Arya's flag (successful webmin exploitation)](/assets/img/GoT/arya_flag_(webmin).png)
...
![And now what?](/assets/img/GoT/meme9.jpg)
...
![IMAP flag](/assets/img/GoT/thereach_imap_flag.png)
...
![gitlist GoT repos](/assets/img/GoT/gitlist.png)
...
![Gitlist RCE](/assets/img/GoT/git_rce_test.png)
...
![Docker escalation](/assets/img/GoT/docker_pwn.png)
...
![MD5 flags](/assets/img/GoT/md5_msg.png)
